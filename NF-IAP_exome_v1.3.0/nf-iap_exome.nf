...
workflow {
  main :
    ...
    if (params.germlineCalling){
      ...
      include gatk_germline_calling from './workflows/gatk_germline_calling_exome.nf' params(params)
    ...
    if (params.variantFiltration){
      include gatk_variantfiltration from './workflows/gatk_variantfiltration_exome.nf' params(params)
      if( gatk_germline_calling.out ){
        gatk_variantfiltration(gatk_germline_calling.out[0].map{
